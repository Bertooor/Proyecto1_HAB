...
async function user (position) {
    ...
    console.log(data);
    li2.textContent = `There will be ${data.list[0].weather[0].main} / ${data.list[0].weather[0].description} `;
    li4.textContent = `There will be ${data.list[1].weather[0].main} / ${data.list[1].weather[0].description} `;
    li6.textContent = `There will be ${data.list[2].weather[0].main} / ${data.list[2].weather[0].description} `;
    li8.textContent = `There will be ${data.list[3].weather[0].main} / ${data.list[3].weather[0].description} `;
    li1.textContent = `On ${data.list[0].dt_txt}`;
    li3.textContent = `On ${data.list[1].dt_txt}`;
    li5.textContent = `On ${data.list[2].dt_txt}`;
    li7.textContent = `On ${data.list[3].dt_txt}`;   
